...
const DetailBar = ({channel, video, nextCallback,previusCallback }:{channel:IChannel, video:IVideo, nextCallback:Function,previusCallback:Function }) => {
    ...
    return (<div className=" z-50 flex   w-full flex-col sm:flex-row    bg-gray-950  ">
        ...
        <div id="channelDetails" className=" basis-3/5 flex-auto pl-10 pr-10 pt-5 ">
        ...
        <a href='https://ko-fi.com/Q5Q71BDVV5' className=" right-0 p-5" target='_blank'><img height='36' className=" h-10 border-none"  src='https://storage.ko-fi.com/cdn/kofi5.png?v=6'  alt='Buy Me a Coffee at ko-fi.com' /></a>
        </div>
    </div>)
}
